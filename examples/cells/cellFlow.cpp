...
/*
    ...
    std::string config_file("/home/jifutan/insituBloodFlow/BloodFlowTan/examples/singleCell/cellFlow.xml");//Configuration file to tell SENSEI what to do with data.
